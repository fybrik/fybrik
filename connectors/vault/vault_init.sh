...
$VAULT_PATH kv put $VAULT_USER_HOME/$APPID/$CATALOG_PROVIDER_NAME  username=$CP4D_USERNAME_TO_BE_STORED_IN_VAULT  password=$CP4D_PASSWORD_TO_BE_STORED_IN_VAULT ownerId=$CP4D_OWNERID_TO_BE_STORED_IN_VAULT
$VAULT_PATH kv get $VAULT_USER_HOME/$APPID/$CATALOG_PROVIDER_NAME
