...
const (
	...
	bluePrintSelfLink          = "/apis/app.fybrik.io/v12/namespaces/%s/blueprints/%s"
...
func (r *razeeClusterManager) GetBlueprint(clusterName, namespace, name string) (*v12.Blueprint, error) {
...
func (r *razeeClusterManager) CreateBlueprint(cluster string, blueprint *v12.Blueprint) error {
...
func (r *razeeClusterManager) UpdateBlueprint(cluster string, blueprint *v12.Blueprint) error {
	channelName := channelName(cluster, blueprint.Name)
