...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in MetricsPerRegion) DeepCopyInto(out *MetricsPerRegion) {
	{
		in := &in
		*out = make(MetricsPerRegion, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricsPerRegion.
func (in MetricsPerRegion) DeepCopy() MetricsPerRegion {
	if in == nil {
		return nil
	}
	out := new(MetricsPerRegion)
	in.DeepCopyInto(out)
	return *out
}
