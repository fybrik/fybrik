...
func (in *BandwidthMatrix) DeepCopyInto(out *BandwidthMatrix) {
	*out = *in
	...
	if in.Values != nil {
		...
		*out = make(map[taxonomy.ProcessingLocation]map[taxonomy.ProcessingLocation]taxonomy.BandwidthMetric, len(*in))
		for key, val := range *in {
			var outVal map[taxonomy.ProcessingLocation]taxonomy.BandwidthMetric
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make(map[taxonomy.ProcessingLocation]taxonomy.BandwidthMetric, len(*in))
				for key, val := range *in {
					(*out)[key] = val
				}
			}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BandwidthMatrix.
...
func (in *Storage) DeepCopyInto(out *Storage) {
	*out = *in
	...
	if in.Values != nil {
		in, out := &in.Values, &out.Values
		*out = make([]taxonomy.StorageAccount, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
