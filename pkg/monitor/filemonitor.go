...
// Run activates a go routine that calls Monitor() upon changes in $DATA_DIR/adminconfig directory
// where DATA_DIR environment variable defines the root directory of the data.
