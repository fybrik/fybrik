...
type RegisterAssetRequest struct {
	...
	DataStore            *_.DataStore `protobuf:"bytes,3,opt,name=data_store,json=dataStore,proto3" json:"data_store,omitempty"`
...
func (x *RegisterAssetRequest) GetDataStore() *_.DataStore {
	if x != nil {
		return x.DataStore
	}
	return nil
...
var file_register_asset_request_proto_goTypes = []interface{}{
	...
	(*_.DataStore)(nil),          // 2: connectors.DataStore
}
