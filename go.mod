...
require (
	...
	github.com/containerd/containerd v1.6.3-0.20220411162415-eed3a2a99815 // indirect
...
replace (
	...
	helm.sh/helm/v3 v3.7.2 => github.com/fybrik/helm/v3 v3.7.2-fybrik-update-fix
)
