...
<table>
    ...
    <tbody><tr>
      ...
      <td>true</td>
        ...
        <td><b><a href="#blueprintspec-1">spec</a></b></td>
        <td>object</td>
        <td>
          BlueprintSpec defines the desired state of Blueprint, which defines the components of the workload's data path that run in a particular cluster. In a single cluster environment there is one blueprint per workload (FybrikApplication). In a multi-cluster environment there is one Blueprint per cluster per workload (FybrikApplication).<br/>
        </td>
        ...
        <td><b><a href="#blueprintstatus-1">status</a></b></td>
        <td>object</td>
        <td>
          BlueprintStatus defines the observed state of Blueprint This includes readiness, error message, and indicators for the Kubernetes resources owned by the Blueprint for cleanup and status monitoring<br/>
        </td>
...
#### Blueprint.spec
<sup><sup>[↩ Parent](#blueprint-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#blueprintspecmoduleskey-1">modules</a></b></td>
        <td>map[string]object</td>
        <td>
          Modules is a map which contains modules that indicate the data path components that run in this cluster The map key is moduleInstanceName which is the unique name for the deployed instance related to this workload<br/>
        </td>
        ...
        <td><b><a href="#blueprintspecapplication-1">application</a></b></td>
        <td>object</td>
        <td>
          ApplicationContext is a context of the origin FybrikApplication (labels, properties, etc.)<br/>
        </td>
...
#### Blueprint.spec.modules[key]
<sup><sup>[↩ Parent](#blueprintspec-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#blueprintspecmoduleskeychart-1">chart</a></b></td>
        <td>object</td>
        <td>
          Chart contains the location of the helm chart with info detailing how to deploy<br/>
        </td>
        ...
        <td><b><a href="#blueprintspecmoduleskeyarguments-1">arguments</a></b></td>
        <td>object</td>
        <td>
          Arguments are the input parameters for a specific instance of a module.<br/>
        </td>
...
#### Blueprint.spec.modules[key].chart
<sup><sup>[↩ Parent](#blueprintspecmoduleskey-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#blueprintspecmoduleskeyargumentsassetsindex-1">assets</a></b></td>
        <td>[]object</td>
        <td>
          Assets define asset related arguments, such as data source, transformations, etc.<br/>
        </td>
...
#### Blueprint.spec.modules[key].arguments.assets[index]
<sup><sup>[↩ Parent](#blueprintspecmoduleskeyarguments-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#blueprintspecmoduleskeyargumentsassetsindexargsindex-1">args</a></b></td>
        <td>[]object</td>
        <td>
          List of datastores associated with the asset<br/>
        </td>
        ...
        <td><b><a href="#blueprintspecmoduleskeyargumentsassetsindextransformationsindex-1">transformations</a></b></td>
        <td>[]object</td>
        <td>
          Transformations are different types of processing that may be done to the data as it is copied.<br/>
        </td>
...
#### Blueprint.spec.modules[key].arguments.assets[index].args[index]
<sup><sup>[↩ Parent](#blueprintspecmoduleskeyargumentsassetsindex-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#blueprintspecmoduleskeyargumentsassetsindexargsindexconnection-1">connection</a></b></td>
        <td>object</td>
        <td>
          Connection has the relevant details for accesing the data (url, table, ssl, etc.)<br/>
        </td>
        ...
        <td><b><a href="#blueprintspecmoduleskeyargumentsassetsindexargsindexvaultkey-1">vault</a></b></td>
        <td>map[string]object</td>
        <td>
          Holds details for retrieving credentials by the modules from Vault store. It is a map so that different credentials can be stored for the different DataFlow operations.<br/>
        </td>
...
#### Blueprint.spec.modules[key].arguments.assets[index].args[index].connection
<sup><sup>[↩ Parent](#blueprintspecmoduleskeyargumentsassetsindexargsindex-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#blueprintspecapplicationselector-1">selector</a></b></td>
        <td>object</td>
        <td>
          Application selector is used to identify the user workload. It is obtained from FybrikApplication spec.<br/>
        </td>
...
#### Blueprint.spec.application.selector
<sup><sup>[↩ Parent](#blueprintspecapplication-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#blueprintspecapplicationselectormatchexpressionsindex-1">matchExpressions</a></b></td>
        <td>[]object</td>
        <td>
          matchExpressions is a list of label selector requirements. The requirements are ANDed.<br/>
        </td>
...
#### Blueprint.spec.application.selector.matchExpressions[index]
<sup><sup>[↩ Parent](#blueprintspecapplicationselector-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#blueprintstatusmoduleskey-1">modules</a></b></td>
        <td>map[string]object</td>
        <td>
          ModulesState is a map which holds the status of each module its key is the moduleInstanceName which is the unique name for the deployed instance related to this workload<br/>
        </td>
        ...
        <td><b><a href="#blueprintstatusobservedstate-1">observedState</a></b></td>
        <td>object</td>
        <td>
          ObservedState includes information to be reported back to the FybrikApplication resource It includes readiness and error indications, as well as user instructions<br/>
        </td>
...
#### Blueprint.status.modules[key]
<sup><sup>[↩ Parent](#blueprintstatus-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
      ...
      <td>true</td>
        ...
        <td><b><a href="#fybrikapplicationspec-1">spec</a></b></td>
        <td>object</td>
        <td>
          FybrikApplicationSpec defines data flows needed by the application, the purpose and other contextual information about the application.<br/>
        </td>
        ...
        <td><b><a href="#fybrikapplicationstatus-1">status</a></b></td>
        <td>object</td>
        <td>
          FybrikApplicationStatus defines the observed state of FybrikApplication.<br/>
        </td>
...
#### FybrikApplication.spec
<sup><sup>[↩ Parent](#fybrikapplication-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#fybrikapplicationspecdataindex-1">data</a></b></td>
        <td>[]object</td>
        <td>
          Data contains the identifiers of the data to be used by the Data Scientist's application, and the protocol used to access it and the format expected.<br/>
        </td>
        ...
        <td><b><a href="#fybrikapplicationspecselector-1">selector</a></b></td>
        <td>object</td>
        <td>
          Selector enables to connect the resource to the application Application labels should match the labels in the selector.<br/>
        </td>
...
#### FybrikApplication.spec.data[index]
<sup><sup>[↩ Parent](#fybrikapplicationspec-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#fybrikapplicationspecdataindexrequirements-1">requirements</a></b></td>
        <td>object</td>
        <td>
          Requirements from the system<br/>
        </td>
...
#### FybrikApplication.spec.data[index].requirements
<sup><sup>[↩ Parent](#fybrikapplicationspecdataindex-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#fybrikapplicationspecdataindexrequirementsflowparams-1">flowParams</a></b></td>
        <td>object</td>
        <td>
          FlowParams include the requirements for particular data flows<br/>
        </td>
        ...
        <td><b><a href="#fybrikapplicationspecdataindexrequirementsinterface-1">interface</a></b></td>
        <td>object</td>
        <td>
          Interface indicates the protocol and format expected by the data user<br/>
        </td>
...
#### FybrikApplication.spec.data[index].requirements.flowParams
<sup><sup>[↩ Parent](#fybrikapplicationspecdataindexrequirements-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#fybrikapplicationspecdataindexrequirementsflowparamsmetadata-1">metadata</a></b></td>
        <td>object</td>
        <td>
          Source asset metadata like asset name, owner, geography, etc Relevant when writing new asset.<br/>
        </td>
...
#### FybrikApplication.spec.data[index].requirements.flowParams.metadata
<sup><sup>[↩ Parent](#fybrikapplicationspecdataindexrequirementsflowparams-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#fybrikapplicationspecdataindexrequirementsflowparamsmetadatacolumnsindex-1">columns</a></b></td>
        <td>[]object</td>
        <td>
          Columns associated with the asset<br/>
        </td>
...
#### FybrikApplication.spec.data[index].requirements.flowParams.metadata.columns[index]
<sup><sup>[↩ Parent](#fybrikapplicationspecdataindexrequirementsflowparamsmetadata-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#fybrikapplicationspecselectorworkloadselector-1">workloadSelector</a></b></td>
        <td>object</td>
        <td>
          WorkloadSelector enables to connect the resource to the application Application labels should match the labels in the selector.<br/>
        </td>
...
#### FybrikApplication.spec.selector.workloadSelector
<sup><sup>[↩ Parent](#fybrikapplicationspecselector-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#fybrikapplicationspecselectorworkloadselectormatchexpressionsindex-1">matchExpressions</a></b></td>
        <td>[]object</td>
        <td>
          matchExpressions is a list of label selector requirements. The requirements are ANDed.<br/>
        </td>
...
#### FybrikApplication.spec.selector.workloadSelector.matchExpressions[index]
<sup><sup>[↩ Parent](#fybrikapplicationspecselectorworkloadselector-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#fybrikapplicationstatusassetstateskey-1">assetStates</a></b></td>
        <td>map[string]object</td>
        <td>
          AssetStates provides a status per asset<br/>
        </td>
        ...
        <td><b><a href="#fybrikapplicationstatusgenerated-1">generated</a></b></td>
        <td>object</td>
        <td>
          Generated resource identifier<br/>
        </td>
        ...
        <td><b><a href="#fybrikapplicationstatusprovisionedstoragekey-1">provisionedStorage</a></b></td>
        <td>map[string]object</td>
        <td>
          ProvisionedStorage maps a dataset (identified by AssetID) to the new provisioned bucket. It allows FybrikApplication controller to manage buckets in case the spec has been modified, an error has occurred, or a delete event has been received. ProvisionedStorage has the information required to register the dataset once the owned plotter resource is ready<br/>
        </td>
...
#### FybrikApplication.status.assetStates[key]
<sup><sup>[↩ Parent](#fybrikapplicationstatus-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#fybrikapplicationstatusassetstateskeyconditionsindex-1">conditions</a></b></td>
        <td>[]object</td>
        <td>
          Conditions indicate the asset state (Ready, Deny, Error)<br/>
        </td>
        ...
        <td><b><a href="#fybrikapplicationstatusassetstateskeyendpoint-1">endpoint</a></b></td>
        <td>object</td>
        <td>
          Endpoint provides the endpoint spec from which the asset will be served to the application<br/>
        </td>
...
#### FybrikApplication.status.assetStates[key].conditions[index]
<sup><sup>[↩ Parent](#fybrikapplicationstatusassetstateskey-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#fybrikapplicationstatusprovisionedstoragekeydetails-1">details</a></b></td>
        <td>object</td>
        <td>
          Dataset information<br/>
        </td>
        ...
        <td><b><a href="#fybrikapplicationstatusprovisionedstoragekeyresourcemetadata-1">resourceMetadata</a></b></td>
        <td>object</td>
        <td>
          Resource Metadata<br/>
        </td>
        ...
        <td><b><a href="#fybrikapplicationstatusprovisionedstoragekeysecretref-1">secretRef</a></b></td>
        <td>object</td>
        <td>
          Reference to a secret where the credentials are stored<br/>
        </td>
...
#### FybrikApplication.status.provisionedStorage[key].details
<sup><sup>[↩ Parent](#fybrikapplicationstatusprovisionedstoragekey-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#fybrikapplicationstatusprovisionedstoragekeydetailsconnection-1">connection</a></b></td>
        <td>object</td>
        <td>
          Connection has the relevant details for accesing the data (url, table, ssl, etc.)<br/>
        </td>
        ...
        <td><b><a href="#fybrikapplicationstatusprovisionedstoragekeydetailsvaultkey-1">vault</a></b></td>
        <td>map[string]object</td>
        <td>
          Holds details for retrieving credentials by the modules from Vault store. It is a map so that different credentials can be stored for the different DataFlow operations.<br/>
        </td>
...
#### FybrikApplication.status.provisionedStorage[key].details.connection
<sup><sup>[↩ Parent](#fybrikapplicationstatusprovisionedstoragekeydetails-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#fybrikapplicationstatusprovisionedstoragekeyresourcemetadatacolumnsindex-1">columns</a></b></td>
        <td>[]object</td>
        <td>
          Columns associated with the asset<br/>
        </td>
...
#### FybrikApplication.status.provisionedStorage[key].resourceMetadata.columns[index]
<sup><sup>[↩ Parent](#fybrikapplicationstatusprovisionedstoragekeyresourcemetadata-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
      ...
      <td>true</td>
        ...
        <td><b><a href="#fybrikmodulespec-1">spec</a></b></td>
        <td>object</td>
        <td>
          FybrikModuleSpec contains the info common to all modules, which are one of the components that process, load, write, audit, monitor the data used by the data scientist's application.<br/>
        </td>
        ...
        <td><b><a href="#fybrikmodulestatus-1">status</a></b></td>
        <td>object</td>
        <td>
          FybrikModuleStatus defines the observed state of FybrikModule.<br/>
        </td>
...
#### FybrikModule.spec
<sup><sup>[↩ Parent](#fybrikmodule-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#fybrikmodulespeccapabilitiesindex-1">capabilities</a></b></td>
        <td>[]object</td>
        <td>
          Capabilities declares what this module knows how to do and the types of data it knows how to handle The key to the map is a CapabilityType string<br/>
        </td>
        ...
        <td><b><a href="#fybrikmodulespecchart-1">chart</a></b></td>
        <td>object</td>
        <td>
          Reference to a Helm chart that allows deployment of the resources required for this module<br/>
        </td>
        ...
        <td><b><a href="#fybrikmodulespecdependenciesindex-1">dependencies</a></b></td>
        <td>[]object</td>
        <td>
          Other components that must be installed in order for this module to work<br/>
        </td>
        ...
        <td><b><a href="#fybrikmodulespecstatusindicatorsindex-1">statusIndicators</a></b></td>
        <td>[]object</td>
        <td>
          StatusIndicators allow to check status of a non-standard resource that can not be computed by helm/kstatus<br/>
        </td>
...
#### FybrikModule.spec.capabilities[index]
<sup><sup>[↩ Parent](#fybrikmodulespec-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#fybrikmodulespeccapabilitiesindexactionsindex-1">actions</a></b></td>
        <td>[]object</td>
        <td>
          Actions are the data transformations that the module supports<br/>
        </td>
        ...
        <td><b><a href="#fybrikmodulespeccapabilitiesindexapi-1">api</a></b></td>
        <td>object</td>
        <td>
          API indicates to the application how to access the capabilities provided by the module<br/>
        </td>
        ...
        <td><b><a href="#fybrikmodulespeccapabilitiesindexpluginsindex-1">plugins</a></b></td>
        <td>[]object</td>
        <td>
          Plugins enable the module to add libraries to perform actions rather than implementing them by itself<br/>
        </td>
        ...
        <td><b><a href="#fybrikmodulespeccapabilitiesindexsupportedinterfacesindex-1">supportedInterfaces</a></b></td>
        <td>[]object</td>
        <td>
          Copy should have one or more instances in the list, and its content should have source and sink Read should have one or more instances in the list, each with source populated Write should have one or more instances in the list, each with sink populated This field may not be required if not handling data<br/>
        </td>
...
#### FybrikModule.spec.capabilities[index].actions[index]
<sup><sup>[↩ Parent](#fybrikmodulespeccapabilitiesindex-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#fybrikmodulespeccapabilitiesindexapiconnection-1">connection</a></b></td>
        <td>object</td>
        <td>
          Connection information<br/>
        </td>
...
#### FybrikModule.spec.capabilities[index].api.connection
<sup><sup>[↩ Parent](#fybrikmodulespeccapabilitiesindexapi-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#fybrikmodulespeccapabilitiesindexsupportedinterfacesindexsink-1">sink</a></b></td>
        <td>object</td>
        <td>
          Sink specifies the output data protocol and format<br/>
        </td>
        ...
        <td><b><a href="#fybrikmodulespeccapabilitiesindexsupportedinterfacesindexsource-1">source</a></b></td>
        <td>object</td>
        <td>
          Source specifies the input data protocol and format<br/>
        </td>
...
#### FybrikModule.spec.capabilities[index].supportedInterfaces[index].sink
<sup><sup>[↩ Parent](#fybrikmodulespeccapabilitiesindexsupportedinterfacesindex-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#fybrikmodulestatusconditionsindex-1">conditions</a></b></td>
        <td>[]object</td>
        <td>
          Conditions indicate the module states with respect to validation<br/>
        </td>
...
#### FybrikModule.status.conditions[index]
<sup><sup>[↩ Parent](#fybrikmodulestatus-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
      ...
      <td>true</td>
        ...
        <td><b><a href="#plotterspec-1">spec</a></b></td>
        <td>object</td>
        <td>
          PlotterSpec defines the desired state of Plotter, which is applied in a multi-clustered environment. Plotter declares what needs to be installed and where (as blueprints running on remote clusters) which provides the Data Scientist's application with secure and governed access to the data requested in the FybrikApplication.<br/>
        </td>
        ...
        <td><b><a href="#plotterstatus-1">status</a></b></td>
        <td>object</td>
        <td>
          PlotterStatus defines the observed state of Plotter This includes readiness, error message, and indicators received from blueprint resources owned by the Plotter for cleanup and status monitoring<br/>
        </td>
...
#### Plotter.spec
<sup><sup>[↩ Parent](#plotter-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#plotterspecassetskey-1">assets</a></b></td>
        <td>map[string]object</td>
        <td>
          Assets is a map holding information about the assets The key is the assetID<br/>
        </td>
        ...
        <td><b><a href="#plotterspecflowsindex-1">flows</a></b></td>
        <td>[]object</td>
        <td>
          <br/>
        </td>
        ...
        <td><b><a href="#plotterspectemplateskey-1">templates</a></b></td>
        <td>map[string]object</td>
        <td>
          Templates is a map holding the templates used in this plotter steps The key is the template name<br/>
        </td>
        ...
        <td><b><a href="#plotterspecappselector-1">appSelector</a></b></td>
        <td>object</td>
        <td>
          Selector enables to connect the resource to the application Application labels should match the labels in the selector. For some flows the selector may not be used.<br/>
        </td>
...
#### Plotter.spec.assets[key]
<sup><sup>[↩ Parent](#plotterspec-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#plotterspecassetskeyassetdetails-1">assetDetails</a></b></td>
        <td>object</td>
        <td>
          DataStore contains the details for accesing the data that are sent by catalog connectors Credentials for accesing the data are stored in Vault, in the location represented by Vault property.<br/>
        </td>
...
#### Plotter.spec.assets[key].assetDetails
<sup><sup>[↩ Parent](#plotterspecassetskey-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#plotterspecassetskeyassetdetailsconnection-1">connection</a></b></td>
        <td>object</td>
        <td>
          Connection has the relevant details for accesing the data (url, table, ssl, etc.)<br/>
        </td>
        ...
        <td><b><a href="#plotterspecassetskeyassetdetailsvaultkey-1">vault</a></b></td>
        <td>map[string]object</td>
        <td>
          Holds details for retrieving credentials by the modules from Vault store. It is a map so that different credentials can be stored for the different DataFlow operations.<br/>
        </td>
...
#### Plotter.spec.assets[key].assetDetails.connection
<sup><sup>[↩ Parent](#plotterspecassetskeyassetdetails-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#plotterspecflowsindexsubflowsindex-1">subFlows</a></b></td>
        <td>[]object</td>
        <td>
          <br/>
        </td>
...
#### Plotter.spec.flows[index].subFlows[index]
<sup><sup>[↩ Parent](#plotterspecflowsindex-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#plotterspecflowsindexsubflowsindexstepsindexindex-1">steps</a></b></td>
        <td>[][]object</td>
        <td>
          Steps defines a series of sequential/parallel data flow steps The first dimension represents parallel data flows. The second sequential components within the same parallel data flow.<br/>
        </td>
...
#### Plotter.spec.flows[index].subFlows[index].steps[index][index]
<sup><sup>[↩ Parent](#plotterspecflowsindexsubflowsindex-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#plotterspecflowsindexsubflowsindexstepsindexindexparameters-1">parameters</a></b></td>
        <td>object</td>
        <td>
          Step parameters TODO why not flatten the parameters into this data flow step<br/>
        </td>
...
#### Plotter.spec.flows[index].subFlows[index].steps[index][index].parameters
<sup><sup>[↩ Parent](#plotterspecflowsindexsubflowsindexstepsindexindex-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#plotterspecflowsindexsubflowsindexstepsindexindexparametersactionindex-1">action</a></b></td>
        <td>[]object</td>
        <td>
          Actions are the data transformations that the module supports<br/>
        </td>
        ...
        <td><b><a href="#plotterspecflowsindexsubflowsindexstepsindexindexparametersapi-1">api</a></b></td>
        <td>object</td>
        <td>
          ResourceDetails includes asset connection details<br/>
        </td>
        ...
        <td><b><a href="#plotterspecflowsindexsubflowsindexstepsindexindexparametersargsindex-1">args</a></b></td>
        <td>[]object</td>
        <td>
          <br/>
        </td>
...
#### Plotter.spec.flows[index].subFlows[index].steps[index][index].parameters.action[index]
<sup><sup>[↩ Parent](#plotterspecflowsindexsubflowsindexstepsindexindexparameters-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#plotterspecflowsindexsubflowsindexstepsindexindexparametersapiconnection-1">connection</a></b></td>
        <td>object</td>
        <td>
          Connection information<br/>
        </td>
...
#### Plotter.spec.flows[index].subFlows[index].steps[index][index].parameters.api.connection
<sup><sup>[↩ Parent](#plotterspecflowsindexsubflowsindexstepsindexindexparametersapi-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#plotterspecflowsindexsubflowsindexstepsindexindexparametersargsindexapi-1">api</a></b></td>
        <td>object</td>
        <td>
          API holds information for accessing a module instance<br/>
        </td>
...
#### Plotter.spec.flows[index].subFlows[index].steps[index][index].parameters.args[index].api
<sup><sup>[↩ Parent](#plotterspecflowsindexsubflowsindexstepsindexindexparametersargsindex-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#plotterspecflowsindexsubflowsindexstepsindexindexparametersargsindexapiconnection-1">connection</a></b></td>
        <td>object</td>
        <td>
          Connection information<br/>
        </td>
...
#### Plotter.spec.flows[index].subFlows[index].steps[index][index].parameters.args[index].api.connection
<sup><sup>[↩ Parent](#plotterspecflowsindexsubflowsindexstepsindexindexparametersargsindexapi-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#plotterspectemplateskeymodulesindex-1">modules</a></b></td>
        <td>[]object</td>
        <td>
          Modules is a list of dependent modules. e.g., if a plugin module is used then the service module is used in should appear first in the modules list of the same template. If the modules list contains more than one module, the first module in the list is referred to as the "primary module" of which all the parameters to this template are sent to.<br/>
        </td>
...
#### Plotter.spec.templates[key].modules[index]
<sup><sup>[↩ Parent](#plotterspectemplateskey-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#plotterspectemplateskeymodulesindexchart-1">chart</a></b></td>
        <td>object</td>
        <td>
          Chart contains the information needed to use helm to install the capability<br/>
        </td>
...
#### Plotter.spec.templates[key].modules[index].chart
<sup><sup>[↩ Parent](#plotterspectemplateskeymodulesindex-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#plotterspecappselectorworkloadselector-1">workloadSelector</a></b></td>
        <td>object</td>
        <td>
          WorkloadSelector enables to connect the resource to the application Application labels should match the labels in the selector.<br/>
        </td>
...
#### Plotter.spec.appSelector.workloadSelector
<sup><sup>[↩ Parent](#plotterspecappselector-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#plotterspecappselectorworkloadselectormatchexpressionsindex-1">matchExpressions</a></b></td>
        <td>[]object</td>
        <td>
          matchExpressions is a list of label selector requirements. The requirements are ANDed.<br/>
        </td>
...
#### Plotter.spec.appSelector.workloadSelector.matchExpressions[index]
<sup><sup>[↩ Parent](#plotterspecappselectorworkloadselector-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#plotterstatusassetskey-1">assets</a></b></td>
        <td>map[string]object</td>
        <td>
          Assets is a map containing the status per asset. The key of this map is assetId<br/>
        </td>
        ...
        <td><b><a href="#plotterstatusblueprintskey-1">blueprints</a></b></td>
        <td>map[string]object</td>
        <td>
          <br/>
        </td>
        ...
        <td><b><a href="#plotterstatusconditionsindex-1">conditions</a></b></td>
        <td>[]object</td>
        <td>
          Conditions represent the possible error and failure conditions<br/>
        </td>
        ...
        <td><b><a href="#plotterstatusflowskey-1">flows</a></b></td>
        <td>map[string]object</td>
        <td>
          Flows is a map containing the status for each flow the key is the flow name<br/>
        </td>
        ...
        <td><b><a href="#plotterstatusobservedstate-1">observedState</a></b></td>
        <td>object</td>
        <td>
          ObservedState includes information to be reported back to the FybrikApplication resource It includes readiness and error indications, as well as user instructions<br/>
        </td>
...
#### Plotter.status.assets[key]
<sup><sup>[↩ Parent](#plotterstatus-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td><b><a href="#plotterstatusblueprintskeystatus-1">status</a></b></td>
        <td>object</td>
        <td>
          BlueprintStatus defines the observed state of Blueprint This includes readiness, error message, and indicators for the Kubernetes resources owned by the Blueprint for cleanup and status monitoring<br/>
        </td>
...
#### Plotter.status.blueprints[key].status
<sup><sup>[↩ Parent](#plotterstatusblueprintskey-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#plotterstatusblueprintskeystatusmoduleskey-1">modules</a></b></td>
        <td>map[string]object</td>
        <td>
          ModulesState is a map which holds the status of each module its key is the moduleInstanceName which is the unique name for the deployed instance related to this workload<br/>
        </td>
        ...
        <td><b><a href="#plotterstatusblueprintskeystatusobservedstate-1">observedState</a></b></td>
        <td>object</td>
        <td>
          ObservedState includes information to be reported back to the FybrikApplication resource It includes readiness and error indications, as well as user instructions<br/>
        </td>
...
#### Plotter.status.blueprints[key].status.modules[key]
<sup><sup>[↩ Parent](#plotterstatusblueprintskeystatus-1)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#plotterstatusflowskeysubflowskey-1">subFlows</a></b></td>
        <td>map[string]object</td>
        <td>
          <br/>
        </td>
        ...
        <td><b><a href="#plotterstatusflowskeystatus-1">status</a></b></td>
        <td>object</td>
        <td>
          ObservedState includes information about the current flow It includes readiness and error indications, as well as user instructions<br/>
        </td>
...
#### Plotter.status.flows[key].subFlows[key]
<sup><sup>[↩ Parent](#plotterstatusflowskey-1)</sup></sup>
