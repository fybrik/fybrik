...
*DefaultApi* | [**updateAsset**](Apis/DefaultApi.md#updateasset) | **PUT** /updateAsset | This REST API updates data asset information to the data catalog configured in fybrik
