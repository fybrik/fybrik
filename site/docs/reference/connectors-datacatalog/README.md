...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**createAssetInfo**](Apis/DefaultApi.md#createassetinfo) | **POST** /createAssetInfo | This REST API writes data asset information to the data catalog configured in fybrik
