...
We list all mandatory and optional fields to be used by all Fybrik components. In addition to the fields we list, Fybrik components may include extra fields as needed. The fields in this section are typically generated by the logging libraries.
