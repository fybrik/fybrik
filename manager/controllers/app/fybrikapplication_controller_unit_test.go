...
func TestDenyOnRead(t *testing.T) {
	...
	application.Spec.Data[0] = app.DataContext{
		...
		Requirements: app.DataRequirements{Interface: &taxonomy.Interface{Protocol: mockup.S3, DataFormat: mockup.Parquet}},
	}
	application.SetGeneration(1)
...
func TestNoReadPath(t *testing.T) {
	...
	application.Spec.Data[0] = app.DataContext{
		...
		Requirements: app.DataRequirements{Interface: &taxonomy.Interface{Protocol: mockup.JdbcDB2}},
	}
	application.SetGeneration(1)
	...
	application.Spec.Data = []app.DataContext{
		{
			...
			Requirements: app.DataRequirements{Interface: &taxonomy.Interface{Protocol: mockup.ArrowFlight}},
		},
		{
