...
const (
	...
	fybrikapplicationLiteral = "fybrikapplication"
)
...
func (r *FybrikApplicationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	sublog := r.Log.With().Str(fybrikapplicationLiteral, req.NamespacedName.String()).Logger()
	...
	logging.LogStructure(fybrikapplicationLiteral, application, log, true, true)
