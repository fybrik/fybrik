...
kubectl get validatingwebhookcpnfigurations -o yaml
kubectl get service webhook-service -n fybrik-system -o yaml
...
kubectl get fybrikmodules -n fybrik-system -o yaml
