...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SequentialSteps) DeepCopyInto(out *SequentialSteps) {
	*out = *in
	if in.Steps != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SequentialSteps.
func (in *SequentialSteps) DeepCopy() *SequentialSteps {
	if in == nil {
		return nil
	}
	out := new(SequentialSteps)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SubFlow) DeepCopyInto(out *SubFlow) {
	*out = *in
	...
	if in.Steps != nil {
		in, out := &in.Steps, &out.Steps
		*out = make([]SequentialSteps, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
