...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExpectedResourceStatus) DeepCopyInto(out *ExpectedResourceStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExpectedResourceStatus.
func (in *ExpectedResourceStatus) DeepCopy() *ExpectedResourceStatus {
	if in == nil {
		return nil
	}
	out := new(ExpectedResourceStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *M4DApplicationStatus) DeepCopyInto(out *M4DApplicationStatus) {
	*out = *in
	...
	if in.DataAccessInstructions != nil {
		in, out := &in.DataAccessInstructions, &out.DataAccessInstructions
...
func (in *M4DModuleSpec) DeepCopyInto(out *M4DModuleSpec) {
	*out = *in
	...
	if in.ResourceStates != nil {
		...
		*out = make([]ExpectedResourceStatus, len(*in))
		copy(*out, *in)
	}
}
