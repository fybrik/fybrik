...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalDataContext) DeepCopyInto(out *ExternalDataContext) {
	*out = *in
	in.ExternalStore.DeepCopyInto(&out.ExternalStore)
	if in.Sensitivity != nil {
		in, out := &in.Sensitivity, &out.Sensitivity
		*out = make([]DataSensitivity, len(*in))
		copy(*out, *in)
	}
	out.IFdetails = in.IFdetails
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalDataContext.
func (in *ExternalDataContext) DeepCopy() *ExternalDataContext {
	if in == nil {
		return nil
	}
	out := new(ExternalDataContext)
	in.DeepCopyInto(out)
	return out
}
...
func (in *M4DApplicationSpec) DeepCopyInto(out *M4DApplicationSpec) {
	*out = *in
	...
	if in.ExternalData != nil {
		...
		*out = make([]ExternalDataContext, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
