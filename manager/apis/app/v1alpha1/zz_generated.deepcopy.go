...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TargetCatalog) DeepCopyInto(out *TargetCatalog) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TargetCatalog.
func (in *TargetCatalog) DeepCopy() *TargetCatalog {
	if in == nil {
		return nil
	}
	out := new(TargetCatalog)
	in.DeepCopyInto(out)
	return out
}
