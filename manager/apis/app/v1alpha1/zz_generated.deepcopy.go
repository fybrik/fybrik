...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CapabilityAPI) DeepCopyInto(out *CapabilityAPI) {
	*out = *in
	out.API = in.API
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CapabilityAPI.
func (in *CapabilityAPI) DeepCopy() *CapabilityAPI {
	if in == nil {
		return nil
	}
	out := new(CapabilityAPI)
	in.DeepCopyInto(out)
	return out
}
