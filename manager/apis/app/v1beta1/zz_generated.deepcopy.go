...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModuleNetwork) DeepCopyInto(out *ModuleNetwork) {
	*out = *in
	if in.Ingress != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModuleNetwork.
func (in *ModuleNetwork) DeepCopy() *ModuleNetwork {
	if in == nil {
		return nil
	}
	out := new(ModuleNetwork)
	in.DeepCopyInto(out)
	return out
}
