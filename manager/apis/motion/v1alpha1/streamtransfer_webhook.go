...
// +kubebuilder:webhook:admissionReviewVersions=v1beta1,sideEffects=None,path=/mutate-motion-m4d-ibm-com-v1alpha1-streamtransfer,mutating=true,failurePolicy=fail,groups=motion.m4d.ibm.com,resources=streamtransfers,verbs=create;update,versions=v1alpha1,name=mstreamtransfer.kb.io
...
// +kubebuilder:webhook:verbs=create;update,admissionReviewVersions=v1beta1,sideEffects=None,path=/validate-motion-m4d-ibm-com-v1alpha1-streamtransfer,mutating=false,failurePolicy=fail,groups=motion.m4d.ibm.com,resources=streamtransfers,versions=v1alpha1,name=vstreamtransfer.kb.io
